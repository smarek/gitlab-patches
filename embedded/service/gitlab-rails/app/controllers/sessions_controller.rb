...
class SessionsController < Devise::SessionsController
  ...
  def destroy
    ...
    saml_provider = Gitlab.config.omniauth.providers.find { |provider| provider.name == 'saml' }

    super unless Gitlab::Auth.omniauth_enabled? || saml_provider.present?

    redirect_to '/users/auth/saml/spslo'
  end
